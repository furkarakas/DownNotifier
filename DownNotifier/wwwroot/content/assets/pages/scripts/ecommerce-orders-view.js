    ...
    var handleInvoices = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "ajax": {
                    "url": "/content/demo/ecommerce_order_invoices.php", // ajax source
                },
                "order": [
                    [1, "asc"]
    ...
    var handleCreditMemos = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "/content/demo/ecommerce_order_credit_memos.php", // ajax source
                },
    ...
    var handleShipment = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "/content/demo/ecommerce_order_shipment.php", // ajax source
                },
                "columnDefs": [{ // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'orderable': true,
                    'targets': [0]
    ...
    var handleHistory = function () {
        ...
        grid.init({
            ...
            dataTable: { // here you can define a typical datatable settings from http://datatables.net/usage/options
                ...
                "pageLength": 10, // default record count per page
                "ajax": {
                    "url": "/content/demo/ecommerce_order_history.php", // ajax source
                },
                "columnDefs": [{ // define columns sorting options(by default all columns are sortable extept the first checkbox column)
                    'orderable': true,
                    'targets': [0]
